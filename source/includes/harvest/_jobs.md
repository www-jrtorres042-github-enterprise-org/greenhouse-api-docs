...
```shell
curl --request POST 'https://harvest.greenhouse.io/v1/jobs
-H Authorization Basic MGQwMzFkODIyN2VhZmE2MWRjMzc1YTZjMmUwNjdlMjQ6" -H On-Behalf-Of 185493
```
...
{
  "id": 112746,
  "name": "External Name That Appears On Job Boards",
  "requisition_id": "abc-123",
