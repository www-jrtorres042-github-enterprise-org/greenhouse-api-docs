...
| Date                    | Description                                                                                                                       |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| May 28, 2020 05:00:00PM | Candidate photos have been removed from Greenhouse and can no longer be anonymized in [PUT Anonymize Candidates](#put-anonymize-candidate) |
