...
The Job Opened event is triggered when a Greenhouse job has "Approvals to start recruiting" configured. When the final approval is received and the job is officially "open for recruiting" then this web hook will be generated.
